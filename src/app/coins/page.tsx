  ...
  try {
    ...
    return (
      <div className="w-full mx-auto">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-3 sm:mb-6">Tüm Coinler</h1>
              ...
              >
                ...
                <div className="text-right">
                  <div className="flex flex-wrap justify-end gap-1">
                    ...
                    {coin.isActive && (
                      <span className="inline-flex items-center rounded-full bg-green-100/10 px-1.5 sm:px-2 py-0.5 sm:py-1 text-[10px] sm:text-xs font-medium text-green-400 ring-1 ring-inset ring-green-500/20">
                        Aktif
                      </span>
                    )}
                  </div>
